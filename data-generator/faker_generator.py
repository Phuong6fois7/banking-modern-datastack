"""This code was generated by ChatGPT to create simulation data.
...
The maximum transaction amount is 1,000 USD."""
...
def run_iteration():
    ...
    print(
        f"Generated {len(customers)} customers, {len(accounts)} accounts, {NUM_TRANSACTIONS} transactions."
    )
